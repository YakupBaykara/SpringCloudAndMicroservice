...
public class CurrencyConversionController {
	...
	public CurrencyConversion calculateCurrencyConvertion(@PathVariable String from, 
...
//		return new CurrencyConversion(10001L, from, to, quantity, BigDecimal.ONE, BigDecimal.ONE, "");
	...
	public CurrencyConversion calculateCurrencyConvertionFeign(@PathVariable String from, 
								@PathVariable String to, @PathVariable BigDecimal quantity) {
